...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        // 加载单个文档
        Document document3 = FileSystemDocumentLoader.loadDocument("E:/knowledge/file.txt", new
                TextDocumentParser());
        // 从一个目录中加载所有文档
...
//并使用默认的文档解析器对文档进行解析(TextDocumentParser)
        Document document = FileSystemDocumentLoader.loadDocument("D:\\knowledge\\人工智能.md");
